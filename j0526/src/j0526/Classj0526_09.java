...
public class Classj0526_09 {
	...
	public static void main(String[] args) {
		...
		String result2 = str2.replace("bbb", "abc"); //문자 대체
		...
		System.out.println("공백 모두 제거 str : "+result4);
		String[] result5 = str2.split(",");
		System.out.println(Arrays.toString(result5)); //주소값을 배열에 넣음
		System.out.println(result5[0]); //값 출력
	}
