...
public class Classj0531_01 {

	public static void main(String[] args) {
		// 다형성 - 부모의 참조변수로 자손의 객체를 다루는 것 
		List list = new ArrayList<>();
		list.add("aaa"); //0 - Object 객체
		list.add("bbb"); //1
		list.add("ccc"); //2
		list.add("aaa"); //3
...
//		list.add(s1);
		list2.add(new Student(1,"홍길동",100,100,99)); //들어가면서 Object 타입으로 변환
		...
		Student ss = list3.get(0); //형변환 안해도 에러안남! 지네릭스 해줬기때문
