...
<html>
	...
	학번 : <jsp:setProperty property="stuNo" name="student"/><br>
	이름 : <jsp:setProperty property="name" name="student"/><br>
	국어 : <jsp:setProperty property="kor" name="student"/><br>
	영어 : <jsp:setProperty property="eng" name="student"/><br>
	수학 : <jsp:setProperty property="math" name="student"/><br>
